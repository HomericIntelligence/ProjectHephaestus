...
_No response_
END_D1555F09CEC972CB_TASK

**Task review — the plan-review verdict (untrusted):**
BEGIN_D1555F09CEC972CB_TASK_REVIEW
## 🔍 Plan Review
...
Grade: A
Verdict: GO
END_D1555F09CEC972CB_TASK_REVIEW

**Current implementation diff (untrusted):**
BEGIN_D1555F09CEC972CB_DIFF
...
index d4f0c0cb..36aa464b 100644
...
@@ -68,6 +100,7 @@ def test_success_output_redacts_private_values(
     monkeypatch: pytest.MonkeyPatch, tmp_path: Path, capsys: pytest.CaptureFixture[str]
 ) -> None:
...
END_D1555F09CEC972CB_DIFF


**Review Threads to Address (untrusted):**
BEGIN_D1555F09CEC972CB_THREADS_JSON
[{"thread_id": "PRRT_kwDOQww0as6Mwurp", "path": "tests/unit/agents/test_runtime.py", "line": 660, "body": "`test_resume_pi_session_passes_resume_id_without_alias_argv_leak` asserts the alias is absent from argv but does not assert `captured['kwargs']['env']['HEPH_PI_MODEL'] == 'private-alias'`. The sibling `run_pi_session` test (line 513) does. Add the env assertion here so both code paths are symmetrically verified."}]
END_D1555F09CEC972CB_THREADS_JSON
...
BEGIN_D1555F09CEC972CB_TODO_LIST
@ tests/unit/agents/test_runtime.py Line 660 - simple - `test_resume_pi_session_passes_resume_id_without_alias_argv_leak` asserts the alias is absent from argv but does not assert `captured['kwargs']['env']['HEPH_PI_MODEL'] == 'private-alias'`. The sibling…
END_D1555F09CEC972CB_TODO_LIST
