...
# _invoke_agent_session and _push_ci_fix were extracted to CIFixOrchestrator
# (#1179). These methods no longer exist on CIDriver; their behaviour is tested
# via the run_ci_fix_session delegation path above.
