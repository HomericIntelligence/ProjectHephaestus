...
@@ -134,11 +127,38 @@ def __init__(self, options: CIDriverOptions) -> None:
...
@@ -963,123 +812,14 @@ def _attempt_mechanical_rebase(
         pr_number: int,
         acquired_slot: int,
     ) -> bool:
...
@@ -2139,27 +1780,8 @@ def _tracked_worktree_changes(self, worktree_path: Path, issue_number: int) -> l
...
+        return self._check_inspector.pending_required_check_names(pr_number)
     ...
     def _force_engagement_prompt(
         self,
@@ -2172,66 +1794,15 @@ def _force_engagement_prompt(
